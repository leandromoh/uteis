...
namespace ConsoleApplication2
{
    class Program
    {
        ...
        {
            criarConexoes();
            estadosParaExplorar.Add(new Caminho("A", 0, 0));
            ...
            while (estadosParaExplorar.Count != 0)
            {
                ...
                {
                    var conexaoPossivel = new Caminho(c.destino, conexao.custoTotal + c.custo, c.custo, conexao);
    ...
    public class Caminho : IComparer<Caminho>
    {
        ...
        public Caminho(string a, int ct, int ca, Caminho p = null)
        {
            atual = a;
            custoTotal = ct;
            custoAtual = ca;
        ...
        {
            return x.custoAtual - y.custoAtual;
        }
    }
